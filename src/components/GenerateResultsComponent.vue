<template>
            ...
            <div class="card-body" style="position: relative">
              ...
              <p class="card-text">
                <small class="text-muted">
                  ...
                  ===> [{{ result_list[0]["userratings"] }} Users<i
            ...
            <div class="card-body" style="position: relative">
              ...
              <p class="card-text">
                <small class="text-muted">
                  ...
                  ===> [{{ result_list[1]["userratings"] }} Users<i
                    class="nes-icon coin is-small"
                  ></i
                  >]
                </small>
            ...
            <div class="card-body" style="position: relative">
              ...
              <p class="card-text">
                <small class="text-muted">
                  ...
                  ===> [{{ result_list[2]["userratings"] }} Users<i
                    class="nes-icon coin is-small"
                  ></i
                  >]
                </small>
  ...
  <div v-else>
    <div
      ...
      style="text-align: center; color: grey; height: 300px"
    >
      <h3>Loading...</h3>
...
export default {
  ...
  async mounted() {
    // qn 1
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/cuisine`)
      .then((response) => {
        this.parameters = response.data + "|";
        // qn 2
      });
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/poultry`)
      .then((response) => {
        this.parameters += response.data + "|";
      });
    // qn 3
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/price`)
      .then((response) => {
        if (response.data == "2") {
          this.maxprice = 4;
          this.minprice = 3;
    ...
    // qn 4
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/texture`)
      .then((response) => {
        this.parameters += response.data + "|";
      });
    // qn 5
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/base`)
      .then((response) => {
        this.parameters += response.data + "|";
      });
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/spice`)
      .then((response) => {
        if (response.data == "2") {
    ...
    await axios
      .get(`${process.env.VUE_APP_BACKEND_URL}api/room/${this.code}/uniqueness`)
      .then((response) => {
    ...
    await axios
      .get(
        `${process.env.VUE_APP_BACKEND_URL}api/createdroom/info/${this.code}`
      )
      .then((response) => {
    ...
    // generate place
    axios
      .post(`${process.env.VUE_APP_BACKEND_URL}api/places`, {
      ...
      .then((response) => {
        if (response["data"]["name1"]) {
          axios.post(
            `${process.env.VUE_APP_BACKEND_URL}api/createdroom/${this.code}`,
            { status: "close" }
          );
